...
$query1="SELECT * FROM boards ORDER BY id DESC";
...
<p class="pathDir"><a href="index.php">首頁</a>&nbsp;&gt;&nbsp;最新消息</p>
    <table id="boards_tb">
    	<tr><th>標題</th><th>內文</th><th>發佈時間</th></tr>
    <?php
    	while($data1=$res1->fetch()){
    		echo "<tr>";
    		echo "<td class=\"subject\"><a href=\"boards_view.php?id=".$data1['id']."\">".mb_substr($data1['subject'],0,30,'utf8')."</a></td>";
    		echo "<td>".mb_substr(strip_tags($data1['content']),0,50,'utf8')."</td>";
