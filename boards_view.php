...
$query1="SELECT * FROM boards WHERE id=".$_GET['id']." ORDER BY id DESC";
...
<p class="pathDir"><a href="index.htm">首頁</a>&nbsp;&gt;&nbsp;<a href="boards.php">最新消息</a></p>
    ...
    <div style="text-align:center;margin-top:30px;margin-bottom:20px;letter-spacing:5px;"><a href="boards.php">返回列表</a></div>
