...
<td width=30% background=pic/5.gif><img border=0 src=pic/9.gif align=absbottom><font color=#FFFFFF><b>用 戶 列 表</b></font></td><td width=70% background=pic/7.gif><img border=0 src=pic/6.gif></td></tr></table></center></div>
<div align="center">
  <center>
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-left-width: 1px; border-right-width: 1px; border-top-width: 1px" bordercolor="<%=c1%>" width="94%">
    <tr>
      <td width="22%" align="center" height="25" bgcolor="<%=c2%>"><b>用戶名</b></td>
      <td width="10%" align="center"><b>性別</b></td>
      <td width="10%" align="center" bgcolor="<%=c2%>"><b>E-mail</b></td>
      <td width="14%" align="center"><b>QQ號碼</b></td>
      <td width="10%" align="center" bgcolor="<%=c2%>"><b>首頁</b></td>
      <td width="10%" align="center"><b>發帖數</b></td>
      <td width="25%" align="center" bgcolor="<%=c2%>"><b>等級</b></td>
    </tr>
  </table>
  </center>
</div>
...
<TBODY>
<TR>
<TD><b><font color="#FFFFFF"><img border="0" src="pic/fl.gif"> 註冊用戶共有</font><font color="#00FFFF"> <%=TotalPage%> </font><font color="#FFFFFF">頁,<font color="#00FFFF"> <%=count%> </font>位，每頁有<font color="#00FFFF"> <%=pagesetup%> </font> 位用戶 >> [
<%
ii=PageCount-5
iii=PageCount+5
if ii < 1 then
