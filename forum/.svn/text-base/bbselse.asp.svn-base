...
myconn.close
set myconn=nothing
response.write"<br><br><form>"&t1&"登 陸 失 敗"&t2&d1&"<br><P style='MARGIN: 10px'>·你的用戶名或密碼錯誤·</p><P style='MARGIN: 10px'>·<a href='javascript:history.go(-1)'>返回重新登陸</a>·</p>"&d2&"</form>"
else
...
myconn.close
set myconn=nothing
response.write"<br><br><form>"&t1&"登 陸 成 功"&t2&d1&"<br><P style='MARGIN:10px'>·<a href='"&kbbs(comeurl)&"'>"&kbbs(comeurl)&"</a>·</p><P style='MARGIN: 10px'>·<a href='index.asp'>進入論壇首頁</a>·</p>"&d2&"</form>"
