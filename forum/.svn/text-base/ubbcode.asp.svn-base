<%
tt1="<font style='font-size:9pt;line-height:15pt'><hr color=#CDCFCE size=1><font color=#3A51B8>"
...
str=re.Replace(str,"$1"&tt1&"此內容需要等級為 <b>"&ii&"</b> 或更高的等級以及作者才能瀏覽：</font><BR>$4"&tt2&"$6")
else
str=re.Replace(str,"$1"&tt1&"此內容需要等級為 <b>"&ii&"</b> 或更高的等級以及作者才能瀏覽：</font><BR>"&tt2&"$6")
end if

re.Pattern="(^.*)(\[showtoname=(.[^\[]*)\])(.[^\[]*)(\[\/s\])(.*)"
usna=re.replace(str,"$3")
if lgname=usna or lgname=myname then
str=re.Replace(str,"$1"&tt1&"此內容只有作者和 <b>$3</b> 能瀏覽：</font><BR>$4"&tt2&"$6")
else
str=re.Replace(str,"$1"&tt1&"此內容只有作者和 <b>$3</b> 能瀏覽：</font><BR>"&tt2&"$6")
end if
...
str=re.Replace(str,"$1"&tt1&"此內容只有作者和已經回覆此帖的瀏覽者能瀏覽：</font><BR>$3"&tt2&"$5")
else
str=re.Replace(str,"$1"&tt1&"此內容只有作者和已經回覆此帖的瀏覽者能瀏覽：</font><BR>"&tt2&"$5")
end if



	re.Pattern="(\[IMG\])(http:\/\/)(.[^\[]*)(\[\/IMG\])"
	str=re.Replace(str,"<a href=//$3 target=_blank><IMG SRC=//$3 border=0 alt=按此在新窗口瀏覽實際大小的圖片 onload=""javascript:if(this.width>screen.width-400)this.width=screen.width-400""></a>")
	re.Pattern="(\[UPLOAD=gif\])(.[^\[]*)(\[\/UPLOAD\])"
	str= re.Replace(str,"<IMG SRC=pic/gif.gif border=0>此主題相關圖片如下：<br><A HREF=upload$2 TARGET=_blank><IMG SRC=upload$2 border=0 alt=按此在新窗口瀏覽圖片 onload=""javascript:if(this.width>screen.width-333)this.width=screen.width-333""></A>")
	re.Pattern="(\[UPLOAD=jpg\])(.[^\[]*)(\[\/UPLOAD\])"
	str= re.Replace(str,"<IMG SRC=pic/jpg.gif border=0>此主題相關圖片如下：<br><A HREF=upload$2 TARGET=_blank><IMG SRC=upload$2 border=0 alt=按此在新窗口瀏覽圖片 onload=""javascript:if(this.width>screen.width-333)this.width=screen.width-333""></A>")
	re.Pattern="(\[UPLOAD=bmp\])(.[^\[]*)(\[\/UPLOAD\])"
	str= re.Replace(str,"<IMG SRC=pic/bmp.gif border=0>此主題相關圖片如下：<br><A HREF=upload$2 TARGET=_blank><IMG SRC=upload$2 border=0 alt=按此在新窗口瀏覽圖片 onload=""javascript:if(this.width>screen.width-333)this.width=screen.width-333""></A>")
	re.Pattern="(\[UPLOAD=(.[^\[]*)\])(.[^\[]*)(\[\/UPLOAD\])"
	str= re.Replace(str,"<IMG SRC=""pic/$2.gif"" border=0> <a href=upload$3>點擊瀏覽該文件</a>")
	re.Pattern="(\[FLASH\])(http://.[^\[]*(.swf))(\[\/FLASH\])"
	str= re.Replace(str,"<a href=""$2"" TARGET=_blank><IMG SRC=pic/swf.gif border=0 alt=點擊開新窗口欣賞該FLASH動畫! height=16 width=16>[全屏欣賞]</a><br><OBJECT codeBase=http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=4,0,2,0 classid=clsid:D27CDB6E-AE6D-11cf-96B8-444553540000 width=500 height=400><PARAM NAME=movie VALUE=""$2""><PARAM NAME=quality VALUE=high><embed src=""$2"" quality=high pluginspage='http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash' type='application/x-shockwave-flash' width=500 height=400>$2</embed></OBJECT>")
	re.Pattern="(\[FLASH=*([0-9]*),*([0-9]*)\])(http://.[^\[]*(.swf))(\[\/FLASH\])"
	str= re.Replace(str,"<a href=""$4"" TARGET=_blank><IMG SRC=pic/swf.gif border=0 alt=點擊開新窗口欣賞該FLASH動畫! height=16 width=16>[全屏欣賞]</a><br><OBJECT codeBase=http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=4,0,2,0 classid=clsid:D27CDB6E-AE6D-11cf-96B8-444553540000 width=$2 height=$3><PARAM NAME=movie VALUE=""$4""><PARAM NAME=quality VALUE=high><embed src=""$4"" quality=high pluginspage='http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash' type='application/x-shockwave-flash' width=$2 height=$3>$4</embed></OBJECT>")
	...
	str=re.Replace(str,"<table width=$1 style=""filter:glow(color=$2, weength=$3)"">$4</table>")
	re.Pattern="\[SHADOW=*([0-9]*),*(#*[a-z0-9]*),*([0-9]*)\](.[^\[]*)\[\/SHADOW]"
	str=re.Replace(str,"<table width=$1 style=""filter:shadow(color=$2, weength=$3)"">$4</table>")
