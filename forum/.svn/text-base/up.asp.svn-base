...
admin="yes"
gl=" <a href=admin-index.asp><font color=#FFFFFF>論壇管理</font></a> |"
else
end if
set cjbz=nothing
lgn=lgname
loy="重新登陸"
zhuzhu="註冊會員"
out="<a href=login.asp?action=exit><font color=#FFFFFF>退出論壇</font></a> |"
end if
response.write"<div align='center'><center><table border='1' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='"&c1&"' width='94%'><tr><td width='100%'><link rel='stylesheet' type='text/css' href='css.css'><body topmargin='0'><table border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse' width='100%'><tr><td background='pic/1.gif' width='60%'> <font color='#FFFFFF'>&nbsp;<b>歡迎你，"&kbbs(lgn)&""&_
"</b> | <a href='login.asp'><font color='#FFFFFF'>"&loy&"</font></a> | <a href='zhuce.asp'><font color='#FFFFFF'>"&zhuzhu&"</font></a> | "&out&""&gl&"</font></td><td width=* background='pic/3.gif'><img border='0' src='pic/2.gif'></td></tr><tr><td width='100%' colspan='2' height='76'>&nbsp;<a href='index.asp'><img border='0' src='pic/logo.gif' style='border-style:solid; border-color:#2C3D8B; '></a></td>"&_
...
response.write"→ <a href='bbsmail.asp'>論壇郵箱</a>"
else
if id<>"" then
...
wname=w1("name")
wriqi=w1("riqi")
weditriqi=w1("editriqi")
wface=w1("face")
whits=w1("hits")
response.write"→ 瀏覽帖子："&LeftTrue(wzhuti,44)&""
end if
end if
set w1=nothing
